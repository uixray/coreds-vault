...
title: "/api/folder/listRecent | Eagle API Document"
---
...
[Previous/api/folder/listchevron-left](https://api.eagle.cool/folder/list) [Next/api/item/addFromURLchevron-right](https://api.eagle.cool/item/add-from-url)
