...
title: "/api/folder/create | Eagle API Document"
---
...
[Previous/api/application/infochevron-left](https://api.eagle.cool/application/info) [Next/api/folder/renamechevron-right](https://api.eagle.cool/folder/rename)
