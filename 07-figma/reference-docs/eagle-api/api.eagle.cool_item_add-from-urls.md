...
title: "/api/item/addFromURLs | Eagle API Document"
---
...
Required，the URL of images to be added. Supports `http`、 `https`、 `base64`
...
[Previous/api/item/addFromURLchevron-left](https://api.eagle.cool/item/add-from-url) [Next/api/item/addFromPathchevron-right](https://api.eagle.cool/item/add-from-path)
